...
namespace MarkdownEditor
{
	...
	//*-------------------------------------------------------------------------*
	/// <summary>
	/// Collection of NamePropertyItem Items.
	/// </summary>
	public class NamePropertyCollection : List<NamePropertyItem>
	{
		//*************************************************************************
		//*	Private																																*
		//*************************************************************************
	...
	//*-------------------------------------------------------------------------*
	/// <summary>
	/// Individual item having a name and properties.
	/// </summary>
	public class NamePropertyItem
	{
		//*************************************************************************
		//*	Private																																*
		//*************************************************************************
